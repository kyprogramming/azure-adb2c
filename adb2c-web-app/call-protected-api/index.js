...
const apiConfig = {
    webApiScopes: [`https://${process.env.TENANT_NAME}.onmicrosoft.com/tasks/tasks.read`],
    anonymousUri: 'http://localhost:5000/public',
    protectedUri: 'http://localhost:5000/hello',
    scopes: ['76a083a9-a161-4765-94fd-a9e900c3d2c7',  'offline_access' , 'profile' ],
};
//</ms_docref_api_config>
...
app.get('/redirect',(req, res)=>{  
    ...
    // tokenRequest.scopes = apiConfig.scopes;
